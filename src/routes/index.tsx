  ...
  head: () => ({
    meta: [
      { title: "HumiSalud — Mejores humidificadores 2026, análisis y guía de compra" },
      {
        name: "description",
        content:
          "Compara humidificadores con criterio: cálculo por m², cuánto gastan de luz y reseñas verificadas. Para bebés, dormitorio, salón y alergias.",
      },
      ...
      { property: "og:url", content: "https://humisalud.com/" },
    ],
    links: [{ rel: "canonical", href: "https://humisalud.com/" }],
  }),
  component: Home,
});
    ...
    <section className="border-b border-border">
      <div className="mx-auto max-w-4xl px-5 pt-14 pb-12 sm:pt-20 sm:pb-16 text-center">
        <p className="text-xs uppercase tracking-[0.22em] text-primary font-medium">
          Guía de compra · Actualizado junio 2026
        </p>
        ...
        <p className="mx-auto mt-6 max-w-2xl border-y border-primary/25 py-4 font-display text-xl sm:text-2xl lg:text-3xl font-semibold text-foreground leading-[1.18]">
          ...
          <span className="text-primary">
            acaba con la garganta seca, la nariz tapada y las noches a medias.
          </span>
        </p>
        <p className="mx-auto mt-4 max-w-2xl text-base sm:text-lg text-muted-foreground leading-relaxed">
          Hemos analizado{" "}
          <strong className="text-foreground font-medium">
            42 humidificadores ultrasónicos y evaporativos
          </strong>{" "}
          para dormitorio, bebé, salón y alergias. Comparamos rendimiento por m², ruido en dB,
          autonomía, limpieza y coste real de luz al mes.
        </p>
  ...
  return (
    <section className="mx-auto max-w-6xl px-5 py-12 sm:py-16">
      <SectionHeader
        ...
        subtitle="Cada situación pesa cosas distintas. El cuarto del bebé pide silencio; el salón pide caudal."
      />
  ...
  return (
    <section className="border-y border-border bg-secondary/30">
      <div className="mx-auto max-w-6xl px-5 py-16 sm:py-20">
        <SectionHeader
          eyebrow="Ranking 2026"
          title="Los cuatro que recomendaríamos hoy"
          subtitle="Si vas con prisa. Si quieres entender por qué están aquí, échale un ojo a cómo trabajamos."
        />
        <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {productos.map((p, i) => (
            <ProductCard
              key={p.slug}
              producto={p}
              badge={i === 0 ? "Mejor opción" : i === 1 ? "Calidad-precio" : undefined}
              highlight={i === 0}
            />
          ))}
        </div>
...
function SelectorSection() {
  return (
    <section className="mx-auto max-w-6xl px-5 py-16 sm:py-20">
      <SectionHeader
        eyebrow="Selector"
        title="Dinos cómo es la habitación y te decimos cuál"
        subtitle="Cinco preguntas. Nada de formularios eternos."
      />
      <div className="mt-10">
        <Selector />
      </div>
    ...
    <section className="border-t border-border bg-secondary/30">
      <div className="mx-auto max-w-6xl px-5 py-16 sm:py-20">
        <SectionHeader
          ...
          title="Por qué esta web no se parece al resto"
          subtitle="Primero el análisis, después las comisiones. Nunca al revés."
        />
        <div className="mt-10">
          <MethodologyBlock />
        </div>
...
function BlogSection() {
  const posts = blogPostsOrdenados.slice(0, 3);
  ...
  return (
    <section className="border-t border-border">
      <div className="mx-auto max-w-6xl px-5 py-16 sm:py-20">
        <SectionHeader
          eyebrow="Del blog"
          title="Análisis y guías recientes"
          subtitle="Lo último que hemos publicado: salud, tecnología y modelos concretos, sin humo."
        />
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {posts.map((p) => (
            <Link
            ...
            >
              ...
              <h3 className="mt-3 font-display text-lg font-semibold leading-snug">{p.titulo}</h3>
              <p className="mt-2 text-sm text-muted-foreground line-clamp-3">{p.resumen}</p>
        ...
        <div className="mt-6 text-center">
          <Link
            ...
            className="inline-flex items-center gap-1 text-sm font-medium text-primary hover:underline underline-offset-4"
          >
            Ver todos los artículos del blog <ArrowRight className="h-4 w-4" />
          </Link>
        </div>
      </div>
    </section>
      ...
      <div className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-primary/90 to-mist-deep p-8 sm:p-14 text-primary-foreground">
        ...
        <div className="relative max-w-2xl">
          ...
          <p className="mt-3 text-base text-primary-foreground/80">
            En vez de leerte diez listas que se parecen, dinos los metros de la habitación, el
            presupuesto y para qué lo quieres. Nosotros te decimos qué encaja.
          </p>
          <div className="mt-7">
            <Link
              to="/selector"
            ...
            >
              Empezar el selector <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
        </div>
      </div>
