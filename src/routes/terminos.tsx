  ...
  component: () => (
    <article className="mx-auto max-w-3xl px-5 py-12 sm:py-16">
      ...
      <div className="mt-6 space-y-4 text-base leading-relaxed">
        <p><strong>Titular del sitio.</strong> HumiSalud es un proyecto editorial gestionado por Juan David Marqués Quiles (particular, NIF 52658246E), con domicilio en Valencia, España. Para cualquier consulta legal o ejercicio de derechos, puedes escribir a <a href="mailto:juandavidmarquesq@gmail.com" className="text-primary underline">juandavidmarquesq@gmail.com</a>.</p>
        ...
        <p>Estos términos se rigen por la legislación española. Para cualquier disputa relacionada con el uso del sitio, las partes se someten a los juzgados y tribunales de Valencia (España), salvo que la normativa de consumidores aplicable indique otro fuero.</p>
      </div>
    </article>
  ),
});
